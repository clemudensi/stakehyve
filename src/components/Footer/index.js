...
const Footer = () => {
 ...
 return(
    ...
    <section className="section no-pdy section-contact bg-theme has-ovm" style={{
    background: "#000000c2"
}}>
                    ...
                    <div className="col-lg-8">
                        <div className="subscribe-wrap bg-foot tc-light round">
                            <div className="section-head section-head-sm wide-auto-sm text-center">
                                ...
                                <p className="text-white">Enroll now, learn about crypto and earn crypto  </p>
                            </div>
        ...
        <div className="nk-ovm ovm-top ovm-h-50 bg-l" style={{background: "rgb(11, 14, 17)"}}></div>
        
    </section>
   
    <section className="section section-footer section-l tc-light bg-theme padme-100" style={{background: "#000000c2"}}>
