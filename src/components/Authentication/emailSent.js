...
import Folder from '../../assets/images/emaill.svg';
        ...
        <main className="nk-pages nk-pages-centered bg-theme bg-pic">
          <div className="ath-container">
            ...
            <div className="ath-body">
              ...
              <div>
                <h6 className="ath-heading title ath-tite">Almost Done!</h6>
                <p className="txtc">Please follow the link in the email to complete the registration process </p>
              </div>
              <Link to='/signin'>          
